...
const PatientDashboard = () => {
  ...
  const handleReschedule = (sessionId: string) => {
    router.push(`/sessions/reschedule/${sessionId}`);
  };
                              ...
                              <div key={content.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                                <div className="flex justify-between items-start">
                                  <div>
                                    ...
                                    <div className="flex items-center mt-1 text-sm text-gray-500">
                                      <Calendar className="w-4 h-4 mr-1" />
                                      {/* <span>{formatSessionDate(content.date)}</span> */}
                                      <span className="mx-2">•</span>
                                      <Clock className="w-4 h-4 mr-1" />
                                      <span>{content.duration}</span>
                                    </div>
                                ...
                                <div className="mt-4 flex space-x-2">
                                  <button 
                                    ...
                                    onClick={() => handleJoinSession(content.id)}
                                  >
                                    Join Session
                                  </button>
                                  <button 
                                    className="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm"
                                    onClick={() => handleReschedule(content.id)}
                                  >
                                    Reschedule
                                  </button>
                                </div>
